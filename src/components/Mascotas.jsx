...
const Mascotas = ({ clientes,setUpdate }) => {
  ...
  const handleDelete = (id) => {
      ...
      fetch(
        "http://localhost:9000/api_clientes/" +
          id +
  ...
  const handleUpdate = (e) => {
    ...
    fetch("http://localhost:9000/api_clientes/" + owners.id+"?accesstoken=eyJhbGciOiJIUzI1NiJ9.amJldGFuY3Vy.7eIqVgwsnN46_jXXw0-sPG2pdnh6PLTZesiH7pTWvSM", requestInit)
      .then((res) => res.text())
      .then((res) => console.log(res));
